...
public class FilmController {
	...
	public String index(Model model) {
		...
		model.addAttribute("view", "film/index");  //use view in film/index
		model.addAttribute("films", filmList);         //put filmList in films

		return "base-layout";   //return base-layout with nested view from above
	}
